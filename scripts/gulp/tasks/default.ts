...
task('help', done => {
  ...
  console.log(chart.yellow('library:build'), 'Build ng-zorro-antd-lib to publish/ directory.');
  console.log(chart.yellow('build:preview'), 'Build preview site to dist/ directory.');
  console.log(
